...
class FindCar extends Component {
  ...
  handleSubmit(event) {
    ...
    if (this.state.from != 'undefined' && this.state.from != '' && this.state.selectedDate2 != null && this.state.selectedDate2 != '' && this.state.selectedDate != null && this.state.selectedDate != '') {
                          ...
                          <Row className='g-3'>
                            <Col lg={3}>
                              <div className='form-group'>
                                ...
                                >
                                  <option selected value="Bhubaneswar">
                                    Bhubaneswar
                                  </option>
                                </select>
                              </div>
                            ...
                            <Col lg={3}>
                                ...
                                <div className='form-group'>
                                  <label for="city">Pickup Address</label>
                                ...
                                <Col lg={2}>
                                <div className='form-group'>
                                  <label for="city">From Date/Time</label>
                               ...
                               <Col lg={2}>
                                <div className='form-group'>
                                  <label for="city">To Date/Time</label>
