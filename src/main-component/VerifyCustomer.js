...
class VehicalAdd extends Component {
   ...
   constructor(props) {
    ...
    imagestore = async () => {
        ...
        const img1='http://127.0.0.1:8000/public/'+result.data.data.license;
        const img2='http://127.0.0.1:8000/public/'+result.data.data.idcard;
        const img3='http://127.0.0.1:8000/public/'+result.data.data.photo;
