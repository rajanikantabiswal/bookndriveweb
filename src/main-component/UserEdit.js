...
class VehicalAdd extends Component {
   ...
   constructor(props) {
      ...
      this.state = { name: '' ,mobile_number:'',email:'',address:'',messages:'',account:'',ifsc:'',bank:'',role:'',coupontime:0}
    ...
    handleSubmit(event) {
      ...
      formData.append('coupontime',this.state.coupontime);
    ...
    imagestore = async () => {
      ...
      // result.data.data.city;
       this.setState({
           ...
           coupontime:result.data.data.coupontime
        });
        ...
        <Fragment>
                    ...
                    <Col md={12}>
                        <div className="breadcromb-box">
                            ...
                            <ul>
                                ...
                                <li> <Link to="/add-user">User update</Link> </li>
                            </ul>
                        </div>
                    </Col>
                </Row>
            ...
            <div className="page page-profile">
                ...
                <div className="tab-content-container">
                    <p className="content-heading">User Update</p>
                    ...
                    <div className="tab-pane active">
                        ...
                        <Form onSubmit={this.handleSubmit} id="account_form">
                            <div className="form-section-0">
                                ...
                                <Col md={2}>
                                    <Form.Label>Coupon Apply Time</Form.Label>
                                </Col>
                                <Col md={4}>
                                    <Form.Control
                                        type="text"
                                        name="coupontime"
                                        value={this.state.coupontime}
                                        onChange={this.handleChange}
